			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-7 order-md-1 order-1">
					...
					<div id="likeButtonContainer">
						<span> <img id="likeButton" src="<%=request.getContextPath()%>/img/투명손가락.png"
...
<!-- javaScript 부분   -->
	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		function likeButton() {
			...
			if (isFilled) {
				button.src = "<%=request.getContextPath()%>/img/투명손가락.png";
			} else {
				button.src = "<%=request.getContextPath()%>/img/검은손가락.png";
			}
			isFilled = !isFilled;
		}
/* 신고하기  부분  */
