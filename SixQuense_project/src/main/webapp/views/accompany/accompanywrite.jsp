    ...
    <div class="container" style="margin-top: 200px;">
        ...
        <div class="row">
            <form action="">
                ...
                <div>
                    <input type="submit" class="btn-success" id="" name="" value="게시글 등록" style="border:0px; margin-left: 965px; height:32px;">
                    <input type="reset" class="btn-success" id="" name="" value="취소">
                </div>
            </form>
        </div>
    </div>
