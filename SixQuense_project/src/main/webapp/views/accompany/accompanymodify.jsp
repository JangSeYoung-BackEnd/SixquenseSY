    ...
    <div class="container" style="margin-top: 200px;">
        ...
        <div class="row">
            <form action="<%=request.getContextPath()%>/accompnay/accompanymodifyend.do?userId=<%=loginMember.getUserId() %>" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <input type="text" id="accompany-title" name="accompany-title" placeholder="제목 : 여행지/날짜/제목내용 으로 작성해주세요" value="<%=accompanys.get(0).getAccompanyTitle()%>" style="width: 700px; border:solid gainsboro; margin-bottom: 10px;">
                </div>
                <div>
                    <input type="text" id="kakao-link" name="kakao-link" placeholder="카카오톡 링크 적어주세요!" value="<%= (accompanys.get(0).getOpenChattingLink() == null) ? "" : accompanys.get(0).getOpenChattingLink() %>" style="width: 700px; border:solid gainsboro;">
                </div>
                ...
                <div class="col-lg-12 file-btn" onclick="openFileDialog();" data-setbg="<%=request.getContextPath()%>/upload/accompany/<%=accompanys.get(0).getRenameFilename()%>">
                ...
                <div>
                    <textarea id="accompany-content" name="accompany-content" placeholder="1. 현재 동행이 있나요?&#13;&#10;ex)혼자에에요/동행 1명이 있어요.&#13;&#10;&#13;&#10;2.어떤 동행을 찾고 있나요?&#13;&#10;ex)맛집 돌아다니는거 좋아하는 20대 여성/남성 동행 구해요!&#13;&#10;&#13;&#10;3. 원하는 여행코스가있다면 적어주세요!&#13;&#10;&#13;&#10;&#13;&#10;글을 작성해주세요(1000자이내)" cols="150" rows="20" maxlength="1000" wrap="on" style="border:solid gainsboro; resize: none;" ><%=accompanys.get(0).getAccompanyContent() %></textarea>
                </div>
                <div>
                    <input type="submit" class="btn-success" value="수정" style="border:0px; margin-left: 965px; height:32px;" >
                    <input type="reset" class="btn-success" value="초기화">
                </div>
            </form>
        </div>
    </div>
