...
.outBox .inputBox input:focus, .outBox.existence .inputBox input {
	border: 2px solid red;
}

.outBox .inputBox input:focus+label, .outBox.existence .inputBox label {
	color: red;
...
<body>
	<form action="">
		<div class="outBox">
			...
			<div class="inputBox">
				<select id="gender" class="selectbox" name="gender" id="gender"
					placeholder="성별">
			...
			<div class="inputBox">
				<input autocomplete="off" placeholder="닉네임 을 정해주세요" id="usernn"
			...
			<span style="display: flex;"> <span class="signup-input-birth">
					<input id="userdd" max="9999" type="text" placeholder="년(4자)"></input>
			</span> <span class="signup-input-birth" style="margin-left: 10px;">
					<select id="signup-birth-mm" class="selectbox" name="userdd"
					onchange="">
