...
/**
 * Servlet implementation class AccompanyModifyEndServlet
 */
@WebServlet("/accompnay/accompanymodifyend.do")
public class AccompanyModifyEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccompanyModifyEndServlet() {
        super();
