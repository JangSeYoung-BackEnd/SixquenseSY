		...
		<div class="row featured__filter">
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic" data-setbg="">
						<img src="./img/eastsouthasia/다낭.png" width="250px;"
							height="265px">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<img src="./img/eastsouthasia/대만.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/featured/feature-6.jpg">
						<img src="./img/eastsouthasia/보라카이.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/featured/feature-6.jpg">
						<img src="./img/eastsouthasia/보홀.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/featured/feature-6.jpg">
						<img src="./img/eastsouthasia/세부클.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/featured/feature-6.jpg">
						<img src="./img/eastsouthasia/코타키나발루.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/featured/feature-6.jpg">
						<img src="./img/eastsouthasia/푸켓.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/featured/feature-6.jpg">
						<img src="./img/eastsouthasia/호치민.png" width="250px;"
							height="265px">
						<ul class="featured__item__pic__hover">
							<li><a href="#"><i class="fa fa-heart"></i></a></li>
							<li><a href="#"><i class="fa fa-retweet"></i></a></li>
...
<div class="announcementtable">
	<div class="btnList">
		<div class="announcementbtn">
			<div width="100%" class="announcementbtn2"
				style="padding: 0px; margin-left: 220px;">
				<button class="anbtn"
					style="font-weight: 500; font-size: 13px; line-height: 19px;">공지사항</button>
				<button class="faqbtn"
					style="font-weight: 500; font-size: 13px; line-height: 19px;">FAQ</button>
			</div>
		</div>
	</div>
</div>
<div class="sc-4eac9403-24 jQrVBe"
	style="margin-right: 0px; right: 320px;">
	<div class="notificationtable">
		<div class="notificationlist">
			<p class="notification">공지사항입니다</p>
		</div>
		<div class="notificationlist">
			<p class="notification">공지사항입니다</p>
		</div>
